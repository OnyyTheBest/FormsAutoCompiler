...
g.k.OE=function(){this.tooltip=new g.hQ(this.player,this);g.I(this,this.tooltip);g.lM(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Ac=new g.sN(this.player);g.I(this,this.Ac);this.Ig=new g.W({G:"div",L:"ytp-miniplayer-scrim"});g.I(this,this.Ig);this.Ig.Da(this.element);this.T(this.Ig.element,"click",this.CA);var a=new g.W({G:"button",Ia:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Chiudi"},U:[g.nK()]});g.I(this,a);a.Da(this.Ig.element);this.T(a.element,"click",this.Li);
...
Ia:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Chiudi"},U:[g.nK()]});g.I(this,a);a.Da(this.qA.element);this.T(a.element,"click",this.Li);a=new g.W({G:"button",Ia:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Chiudi"},U:[g.sK()]});g.I(this,a);a.Da(this.qA.element);this.T(a.element,"click",this.fW);this.T(this.player,"presentingplayerstatechange",this.Qc);this.T(this.player,"appresize",this.yb);this.T(this.player,"fullscreentoggled",this.yb);this.yb()};
