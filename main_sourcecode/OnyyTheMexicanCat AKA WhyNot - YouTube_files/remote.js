...
L:"ytp-mdx-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-popup-title",va:"Disconnessione eseguita"},{G:"div",L:"ytp-mdx-popup-description",va:"I video che guardi potrebbero essere aggiunti alla cronologia delle visualizzazioni della TV e influenzare i consigli sulla TV. Per evitare che ci\u00f2 avvenga, annulla l'operazione e accedi a YouTube dal tuo computer."},{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Ia:["ytp-button","ytp-mdx-privacy-popup-cancel"],
va:"Annulla"},{G:"button",Ia:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Conferma"}]}]}]});this.i=new g.QK(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.I(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.W.call(this,{G:"div",
...
b=g.T(b,128)?g.rH("Errore su $RECEIVER_NAME",c):b.Ic()||g.T(b,4)?g.rH("In riproduzione su $RECEIVER_NAME",c):g.rH("Connesso a $RECEIVER_NAME",c);a.Qa("statustext",b);a.i.show()}else a.i.hide()},O9=function(a,b){g.xP.call(this,"Riproduci su",0,a,b);
...
O9.prototype.uj=function(a){return"cast-selector-receiver"===a?"Trasmetti\u2026":this.Ko[a].name};
